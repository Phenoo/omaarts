        ...
        <div className="art-detail">
          ...
          <article className="art-detail__copy">
            ...
            <div className="purchase-panel">
              <div className="mb-3">
                <span className="text-[11px] font-mono uppercase tracking-[0.16em] text-[var(--text-muted)] block mb-1">Price</span>
                <p className="font-serif text-3xl md:text-4xl font-bold text-[var(--accent-purple)] leading-none">
                  {purchasable ? formatNaira(artwork.price) : 'Price on request'}
                </p>
              </div>
              <p className="text-sm text-[var(--text-muted)]">Shipping, pickup, framing, and certificate-of-authenticity details are confirmed with the studio before purchase.</p>
