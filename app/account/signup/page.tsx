...
export default function SignupPage() {
  const { signup, loginWithGoogle, isAuthenticated, loading: authLoading } = useCustomerAuth();
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      console.error('Customer Google sign-up failed:', {
        code: firebaseError.code || 'unknown',
        message: firebaseError.message || 'No error message provided',
      });
      switch (firebaseError.code) {
        case 'auth/unauthorized-domain':
          setError('Google sign-up is not authorized for this website. Please contact support.');
          break;
        case 'auth/popup-blocked':
          setError('Your browser blocked the Google sign-up window. Allow pop-ups for this site and try again.');
          break;
        case 'auth/popup-closed-by-user':
        case 'auth/cancelled-popup-request':
          setError('Google sign-up was cancelled. Please try again when you are ready.');
          break;
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-sm text-[var(--text-muted)]">
              Save artworks, track orders, and book experiences with ease.
            </p>
          </div>
