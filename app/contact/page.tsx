...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Contact | Artsy by Oma', description: 'Start a conversation with Oma Achebe and the Artsy by Oma studio.', url: '/contact', images: [{ url: '/images/studio/IMG_0890.png', alt: 'The Artsy by Oma creative studio in Awka' }] },
};
