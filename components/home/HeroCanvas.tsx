...
export default function HeroCanvas() {
  ...
  return (
    <section ref={containerRef} className="relative w-full h-screen overflow-hidden bg-[#F9F9F9]">
      ...
      <div ref={textRef} className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none mix-blend-difference">
        <h1 className="text-9xl font-serif text-[#F9F9F9] opacity-90 tracking-tighter text-center leading-[0.8] [text-shadow:0_0_40px_var(--accent-primary)]">
          ARTS BY<br/>OMA
        </h1>
        <p className="mt-8 text-xl font-mono text-[#F9F9F9] tracking-widest uppercase bg-transparent border border-[#F9F9F9]/30 px-4 py-2 backdrop-blur-sm [box-shadow:0_0_20px_var(--accent-secondary)]">
