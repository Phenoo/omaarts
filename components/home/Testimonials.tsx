...
const QUOTES = [
  {
    text: "Oma Achebe's work transformed our lobby into a sanctuary. The texture is palpable even from a distance.",
    author: "Elena R.",
    role: "Interior Architect",
  },
  {
    text: "A profound understanding of color and space. Her pieces are not just decoration; they are a presence.",
    author: "Marcus T.",
